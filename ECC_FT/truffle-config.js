...
module.exports = {
  ...
  networks: {
    ...
    advanced: {
      ...
      gas: 200111555,           // Gas sent with each transaction (default: ~6700000)
      gasPrice: 200000  // 20 gwei (in wei) (default: 100 gwei)
      // from: <address>,        // Account to send txs from (default: accounts[0])
      // websockets: true        // Enable EventEmitter interface for web3 (default: false)
    },

    // IH: starting local blockchain with Ganache (!!! note that testrpc no longer works with custom options !!!)
    // $> ganache-cli -p 8777 -l 250111555 -i 1234 --allowUnlimitedContractSize -a 100
    
    // IH: skipping compilation during tests:
    // 1) truffle compile --network advanced
    // 2) truffle test --network advanced ./test/TestBCVoting.js
